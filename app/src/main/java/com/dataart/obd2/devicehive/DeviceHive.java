...
import com.dataart.obd2.BuildConfig;
...
public class DeviceHive extends Device {
    ...
    public DeviceHive(Context context) {
        super(context, getTestDeviceData());
        attachEquipment(new DeviceEquipment());
    ...
    public static DeviceHive newInstance(Context context) {

        final DeviceHive device = new DeviceHive(context);
